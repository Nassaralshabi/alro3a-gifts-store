...
function RouteLoading() {
  return <div className="grid min-h-[42vh] place-items-center bg-white"><div className="h-8 w-8 animate-spin rounded-full border-2 border-[#d7c5e0] border-t-[#7953a2]" /></div>;
}
