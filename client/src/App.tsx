...
export default function App() { return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><LocaleProvider><Toaster richColors position="top-center" /><Router /></LocaleProvider></TooltipProvider></ThemeProvider></ErrorBoundary>; }
