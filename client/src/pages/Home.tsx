...
const HERO_BRAND_LOGO = "/manus-storage/store-media/390001/processed-logo-al-rawhaa-png-93d69af7-40c8-4396-8959-4d4b1cc612d7_4c62e8cc.png";
...
function HeroCarousel({ slides, isArabic, children }: { slides: HeroSlide[]; isArabic: boolean; children: (slide: HeroSlide) => ReactNode }) {
  ...
  return <div className="relative min-h-[350px] overflow-hidden bg-[#102f39] sm:min-h-[430px]">
    ...
    <div className="absolute right-4 top-4 z-20 rounded-xl border border-white/30 bg-[#102f39]/90 p-1.5 shadow-[0_10px_28px_-12px_rgba(4,27,34,.85)] backdrop-blur-sm sm:right-6 sm:top-6"><img src={HERO_BRAND_LOGO} alt={isArabic ? "شعار Al Rawhaa" : "Al Rawhaa logo"} width={96} height={96} className="h-11 w-11 rounded-lg object-cover sm:h-12 sm:w-12" /></div>
