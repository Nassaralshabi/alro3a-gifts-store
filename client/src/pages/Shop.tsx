...
import { filterCatalogProducts, getCatalogPage, type PriceOrder } from "@/lib/catalogFilters";
...
export default function Shop() {
  ...
  const query = new URLSearchParams(typeof window === "undefined" ? location.split("?")[1] || "" : window.location.search).get("search")?.trim().toLocaleLowerCase() || "";
